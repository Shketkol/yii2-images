...
class Image extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['itemId', 'isMain', 'user_id', 'position'], 'integer'],
            [['name'], 'string', 'max' => 80],
    ...
    public function getUrlAttach($size = false){
        $url = $this->getModule()->pathImageOrigin.'/'.$this->filePath;
        return $url;
    }
    ...
    public function getPositionAttributes()
    {
        return ['user_id', 'modelName', 'itemId'];
    }
}
