...
{
    public $controllerNamespace = 'shketkol\images\src\controllers';

    public $imagesStorePath = '@app/web/store';

    public $imagesCachePath = '@app/web/imgCache';

    public $imagesTempPath = '@app/web/imgCache';

    public $pathImageOrigin = '@app/web/store';
    ...
    public function getModelSubDir($model)
    {
        ...
        if (empty($model->id)){
            $modelDir = \yii\helpers\Inflector::pluralize($modelName);
        } else {
